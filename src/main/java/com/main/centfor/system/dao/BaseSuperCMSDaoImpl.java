package com.main.centfor.system.dao;
...
import com.main.centfor.frame.dao.BaseJdbcDaoImpl;
import com.main.centfor.frame.dao.dialect.IDialect;
import com.main.centfor.frame.entity.IAuditLog;

/**
 *   bbz项目的基础Dao,代理demo数据库
 * @copyright {@link 9iu.org}
 * @author bbz<Auto generate>
 * @version  2013-03-19 11:08:15
 * @see com.BaseSuperCMSDaoImpl.system.dao.BaseDemoDaoImpl
 */
@Repository("baseSuperCMSDao")
public class BaseSuperCMSDaoImpl extends BaseJdbcDaoImpl implements IBaseSuperCMSDao{
