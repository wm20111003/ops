...
import com.main.centfor.system.entity.Menu;
import com.main.centfor.system.entity.Org;
import com.main.centfor.system.service.IMenuService;
 ...
 * @Package com.main.centfor.bbz.web
 * @Description: o
 * @author ZhangNan
...
public class MenuController  extends BaseController {
	...
	public String tree(HttpServletRequest request, Model model,Org org) 
			throws Exception {
		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
		returnObject.setData("/system/menu/list/json");
		model.addAttribute(GlobalStatic.returnDatas, returnObject);
	...
	ReturnDatas destroy(HttpServletRequest request) throws Exception {
		...
		try {
			...
			if (StringUtils.isNotBlank(id)) {
				menuService.deleteMenuRoleByMenuId(id);
