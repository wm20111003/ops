...
import com.main.centfor.frame.util.CaptchaUtils;
...
//	        }
			...
			try {
				//会调用 shiroDbRealm 的认证方法 com.main.centfor.frame.shiro.ShiroDbRealm.doGetAuthenticationInfo(AuthenticationToken)
				user.login(token);
