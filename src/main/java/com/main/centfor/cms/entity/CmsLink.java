 ...
 * @see com.main.centfor.cms.entity.CmsLink
 */
@Table(name="cms_link")
public class CmsLink  extends BaseEntity {
    ...
    */
	...
	public String getNodeftlId() {
		return nodeftlId;
	}

	public void setNodeftlId(String nodeftlId) {
		this.nodeftlId = nodeftlId;
	}
