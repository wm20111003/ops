...
public class Constants {
	 ...
	 * 首页模板
	 */
	public static final String TPLDIR_INDEX = "site";
	/**
	 * 栏目页模板
	 */
	...
	public static final String[][] ostype = { { "pc", "电脑" }, { "weixin", "微信" }, { "mobile", "手机" } };

	public static final String[][] modelType = { { "site", "站点" },
			{ "channel", "栏目" }, { "content", "文章" } };

	public static Map<String, String> getkv(String[][] ss) {
	...
	public static Map<String, String> getvk(String[][] ss) {
		Map<String, String> map = new HashMap<String, String>();
		if (ss != null && ss.length > 0) {
			for (String[] s : ss) {
				map.put(s[1], s[0]);
	...
	public static Set<String> getk(String[][] ss){
		Map<String, String> map=getkv(ss);
		return map.keySet();
	}
}
