 ...
 * 
 */
package com.main.centfor.frame.service;
...
import com.main.centfor.frame.util.SpringUtils;

import freemarker.template.Template;
/**
 * 基础的Service父类,所有的Service都必须继承此类,每个数据库都需要一个实现.</br> 
 * 例如 demo数据的实现类是com.main.centfor.centfor.service.BasedemoServiceImpl,demo2数据的实现类是com.main.centfor.demo2.service.Basedemo2ServiceImpl</br>
 * 
 * @copyright {@link 9iu.org}
 * @author centfor<Auto generate>
 * @version  2013-03-19 11:08:15
 * @see com.main.centfor.frame.service.BaseServiceImpl
 */
public abstract class BaseServiceImpl extends BaseLogger implements
	...
	@Override
	public Object savedFromExcel(List list)throws Exception{
		return null;
	}
