package com.main.centfor.frame.dao;
...
import com.main.centfor.frame.common.BaseLogger;
import com.main.centfor.frame.common.SessionUser;
import com.main.centfor.frame.dao.dialect.IDialect;
import com.main.centfor.frame.entity.IAuditLog;
import com.main.centfor.frame.util.ClassUtils;
import com.main.centfor.frame.util.EntityInfo;
...
import com.main.centfor.frame.util.RegexValidateUtils;
import com.main.centfor.frame.util.SecUtils;
import com.main.centfor.frame.util.WhereSQLInfo;

/**
 * 基础的Dao父类,所有的Dao都必须继承此类,每个数据库都需要一个实现.</br>
 * 
 * 例如 demo数据的实现类是com.main.centfor.springrain.dao.BasedemoDaoImpl,demo2数据的实现类是org. springrain
 * demo2.dao.Basedemo2DaoImpl</br>
 * 
 * @copyright {@link 9iu.org}
 * @author springrain<Auto generate>
 * @version 2013-03-19 11:08:15
 * @see com.main.centfor.frame.dao.BaseJdbcDaoImpl
 */
public abstract class BaseJdbcDaoImpl extends BaseLogger implements IBaseJdbcDao {
	 ...
	 * 例如:demo数据库的代理Dao com.main.centfor.springrain.dao.BasedemoDaoImpll
	 * 实现返回的是spring的beanjdbc.</br> demo2 数据库的代理Dao
	 * com.main.centfor.demo2.dao.Basedemo2DaoImpl 实现返回的是spring的bean jdbc_demo2.</br>
	 * 
	 * @return
	 */
	 ...
	 * 数据库的代理Dao com.main.centfor.springrain.dao.BasedemoDaoImpl 实现返回的是spring的bean
	 * jdbcCall.</br> datalog 数据库的代理Dao com.main.centfor.demo2.dao.Basedemo2DaoImpl
	 ...
	 * com.main.centfor.frame.dao.dialect.IDialect的实现
	 * 
	 * @return
	 */
